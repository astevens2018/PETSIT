...
h5 = Host.create!(
  ...
  description: "I love taking care of birds",
...
h6 = Host.create!(
  ...
  description: "Rabbits are the love of my life",
...
h9 = Host.create!(
  ...
  description: "I currently broke up with my boyfriend after realizing that I just enjoy more riding horses",
...
h10 = Host.create!(
  ...
  description: "During my vacation in thailand some random monkey came up to me and gave me a banana. They are just so lovely",
...
h11 = Host.create!(
  ...
  description: "Eating cereals while watching fishes is my passion",
